...
namespace EyeDropper.UI.Behaviors;
...
public class RoutedCommandBinding : Behavior<FrameworkElement>
{
    ...
    /// <summary>
    /// Called after the behavior is attached to its <see cref="AssociatedObject"/>.
    /// Registers the <see cref="CommandBinding"/> for the specified <see cref="RoutedCommand"/>.
    /// </summary>
