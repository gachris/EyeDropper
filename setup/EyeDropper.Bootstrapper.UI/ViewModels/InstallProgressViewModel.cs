...
/// <summary>
/// ViewModel for displaying installation progress and handling cancellation.
/// </summary>
public partial class InstallProgressViewModel : ObservableObject, INavigationViewModelAware
{
    ...
    /// <summary>
    /// Gets or sets the current installation progress percentage (0–100).
    /// </summary>
    [ObservableProperty]
    ...
    /// <summary>
    /// Gets a value indicating whether the installation has been canceled.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="InstallProgressViewModel"/> class.
    ...
    /// </param>
    public InstallProgressViewModel(IWpfBootstrapperApplicationManager bootstrapperApplicationManager)
    {
    ...
    public void OnNavigated()
    {
        ...
        _bootstrapperApplicationManager.Install();
    }
    ...
    /// <summary>
    /// Cancels the installation process. Prompts for confirmation if in full display mode.
    /// </summary>
    ...
    private void Cancel()
    {
        ...
        if (_bootstrapperApplicationManager.Display is Display.Full)
        {
            var result = MessageBox.Show(
                ...
                Resources.Cancel_installation_message,
                Resources.Cancel_installation_title,
